...
READ_JOB_DESCRIPTION_FROM = "/Users/bhoomikaraval/Resume_screener/Resume-JD-App/Data/Resumes/"
...
class ResumeProcessor:
    ...
    def process(self) -> bool:
        try:
            resume_dict,resume_data = self._read_resumes()
            return resume_dict,resume_data
